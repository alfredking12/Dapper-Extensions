...
namespace DapperExtensions
{
    public static class DapperExtensions
    {
        ...
        /// </summary>
        public static bool Update<T>(this IDbConnection connection, T entity, IDbTransaction transaction = null, List<string> updatedColumns = null, int? commandTimeout = null) where T : class
        {
            return Instance.Update<T>(connection, entity, transaction, updatedColumns, commandTimeout);
        }
