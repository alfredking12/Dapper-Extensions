...
namespace DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        bool Update<T>(IDbConnection connection, T entity, IDbTransaction transaction, List<string> updatedColumns, int? commandTimeout) where T : class;
    ...
    public class DapperImplementor : IDapperImplementor
    {
        ...
        public bool Update<T>(IDbConnection connection, T entity, IDbTransaction transaction, List<string> updatedColumns, int? commandTimeout) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate predicate = GetKeyPredicate<T>(classMap, entity);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            string sql = SqlGenerator.Update(classMap, predicate, parameters, updatedColumns);
