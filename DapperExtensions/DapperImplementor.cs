...
namespace DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        bool Update<T>(IDbConnection connection, T entity, IDbTransaction transaction, int? commandTimeout) where T : DapperEntity;
    ...
    public class DapperImplementor : IDapperImplementor
    {
        ...
        public bool Update<T>(IDbConnection connection, T entity, IDbTransaction transaction, int? commandTimeout) where T : DapperEntity
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate predicate = GetKeyPredicate<T>(classMap, entity);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            string sql = SqlGenerator.Update(classMap, entity, predicate, parameters);
